...
def _stream_flow_csv(
    ...
    *,
    ...
    for raw in rows_it:
        ...
        # To investigate hook (NZ0_/NZ1_/DNA_/DNS_ + egress KUB_/LBI_/LBO_/USR_/U_)
        if do_inv:
            elected_val = ""
...
def _build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        ...
        action="store_true",
        help="Create a 'To investigate' sheet for NZ0_/NZ1_/DNA_/DNS_ elected IPLists (plus egress KUB_/LBI_/LBO_/USR_/U_)",
    )
